...
public class PolynomialFit {
    ...
    public static void main(String[] args){
		PolynomialFit fit = new PolynomialFit(2);
		
		double[] samplePoints = new double[]{1, 4, 9, 16};
		double[] observations = new double[]{1, 4, 9, 16};
		
		fit.fit(samplePoints, observations);
		
		double[] result = fit.getCoef();
