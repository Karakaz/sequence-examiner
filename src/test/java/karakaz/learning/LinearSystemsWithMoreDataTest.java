...
public class LinearSystemsWithMoreDataTest{

	private static final double DELTA = 0.0000000001;

	private static final double[][] A = new double[][]{ { 1, 1, 1, 1 }, { 8, 4, 2, 1 }, { 27, 9, 3, 1 }, { 64, 16, 4, 1 }, {125, 25, 5, 1} };
	private static final double[] b = new double[]{ 0, 12, 10, 0, -12 };
	...
	public void EJML_ThirdDegreeSystem(){
		...
		DenseMatrix64F constants = new DenseMatrix64F(new double[][]{ {b[0]}, {b[1]}, {b[2]}, {b[3]}, {b[4]} });
